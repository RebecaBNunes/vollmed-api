...
public class PacienteController {
	...
	@PostMapping
	@Transactional
	public ResponseEntity<DadosDetalhamentoPaciente> cadastroPaciente(@RequestBody @Valid DadosCadastroPaciente dadosPaciente, UriComponentsBuilder uriBuilder) {
