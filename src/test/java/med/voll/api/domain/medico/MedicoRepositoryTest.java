...
@DataJpaTest
@AutoConfigureTestDatabase(replace = Replace.NONE) //não substitua as configurações do meu banco de dados para utilizar o banco de dados em memória, use o meu próprio banco msm
@ActiveProfiles("test")
class MedicoRepositoryTest {
	...
	void testEscolherMedicoAleatorioLivreNaDataCenario2() {
		var proximaSegundaAs10 = LocalDate.now()
				.with(TemporalAdjusters.next(DayOfWeek.MONDAY))
				.atTime(10, 0); //atTime seta o horario
		var medico = cadastrarMedico("medico", "medico@voll.med", "123456", Especialidade.CARDIOLOGIA);
